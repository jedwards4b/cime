...
!----------------------------------------------------------------------------------
  ...
  subroutine cime_run_calc_budgets1()
    ...
    if (iamin_CPLID) then
       ...
       if (lnd_present) then
          call seq_diag_lnd_mct(lnd(ens1), fractions_lx(ens1), do_l2x=.true., do_x2l=.true.)
       endif
       if (rof_present) then
          call seq_diag_rof_mct(rof(ens1), fractions_rx(ens1))
       endif
       if (ice_present) then
          call seq_diag_ice_mct(ice(ens1), fractions_ix(ens1), do_x2i=.true.)
       endif
...
!----------------------------------------------------------------------------------
  ...
  subroutine cime_run_calc_budgets2()
    ...
    if (iamin_CPLID) then
       ...
       if (atm_present) then
          call seq_diag_atm_mct(atm(ens1), fractions_ax(ens1), do_a2x=.true., do_x2a=.true.)
       endif
       if (ice_present) then
          call seq_diag_ice_mct(ice(ens1), fractions_ix(ens1), do_i2x=.true.)
       endif
