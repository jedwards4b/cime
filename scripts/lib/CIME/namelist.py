...
FORTRAN_NAME_REGEX = re.compile(r"""(^[a-z][a-z0-9_@]{0,62})                            #  The variable name
                                  ...
                                  (([+-]?[a-z0-9_@]{0,62})                         # Single valued index
                                  |                                                     # or
...
class Namelist(object):
    ...
    def write(self, out_file, groups=None, append=False, format_='nml', sorted_groups=True):
        ...
        """
        expect(format_ in ('nml', 'rc', 'nmlcontents', 'roms'),
    ...
    def _write(self, out_file, groups, format_, sorted_groups):
        ...
        if format_ == 'roms':
            sep = ' '
        if format_ in ('nml', 'nmlcontents', 'roms'):
            default_equals = ' ='            
        elif format_ == 'rc':
            default_equals = ':'
        if (sorted_groups):
        ...
        for group_name in group_names:
            ...
            if format_ == 'nml':
                out_file.write("/\n")
            if format_ == 'nmlcontents' or format_ == 'roms':
                out_file.write("\n")
