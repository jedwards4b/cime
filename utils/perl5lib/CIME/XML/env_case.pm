...
BEGIN{
    $logger = get_logger("CIME::XML::env_case");
}
...
# if the file is found read it, otherwise create an xml object (not a file - that comes later). 
	  ...
	  my $headernode = $headerobj->GetHeaderNode("env_case.xml");	  
...
sub write {
    ...
    $this->SUPER::write("env_case.xml");
    
}

1;
 
=head1 CIME::XML::env_case

CIME::XML::env_case a module interface to the file env_case.xml in the case directory
...
CIME::XML::env_case is a perl module to ...
...
CIME::XML::env_case inherits from CIME::XML::GenericEntry, please see the description of that module 
